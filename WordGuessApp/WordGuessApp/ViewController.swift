...
//  WordGuessApp
//
//  Created by Mudhagoni,Sai Kumar on 2/22/22.
//
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var letterEnterd: UITextField!
    ...
    @IBAction func enterlabel(_ sender: Any) {
        var textEnterd = letterEnterd.text!;
